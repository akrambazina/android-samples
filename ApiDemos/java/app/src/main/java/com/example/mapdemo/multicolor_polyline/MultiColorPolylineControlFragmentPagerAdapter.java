...
public class MultiColorPolylineControlFragmentPagerAdapter extends FragmentPagerAdapter {
    ...
    public MultiColorPolylineControlFragmentPagerAdapter(FragmentManager fragmentManager, boolean isLiteMode) {
