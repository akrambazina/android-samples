...
package com.example.mapdemo.multicolor_polyline;
 ...
 */
public class MultiColorPolylineDemoActivity extends AppCompatActivity implements
    OnMapReadyCallback, OnPageChangeListener, OnCheckedChangeListener, OnPolylineClickListener {

    public static final String TAG = MultiColorPolylineDemoActivity.class.getSimpleName();
    ...
    private MultiColorPolylineControlFragmentPagerAdapter pagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pagerAdapter =
            new MultiColorPolylineControlFragmentPagerAdapter(
