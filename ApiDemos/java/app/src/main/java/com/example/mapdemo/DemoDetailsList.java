...
import com.example.mapdemo.multicolor_polyline.MultiColorPolylineDemoActivity;
...
public final class DemoDetailsList {
    ...
    public static final DemoDetails[] DEMOS = {
        ...
        new DemoDetails(R.string.cloud_styling_label,
            ...
            CloudStylingBasicDemoActivity.class),
        ...
        new DemoDetails(R.string.multicolor_polyline_label,
            R.string.multicolor_polyline_description,
            MultiColorPolylineDemoActivity.class),
