...
/**
 * This shows how to use Cloud Styling in a simple Activity. For more information on how to style
 * a map using this method, see:
 * https://developers.google.com/maps/documentation/cloud-styling/cloud-styling-android
 **/
public class CloudStylingBasicDemoActivity extends AppCompatActivity implements OnMapReadyCallback {
